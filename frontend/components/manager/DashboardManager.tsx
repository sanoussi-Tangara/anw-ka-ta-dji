      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {activeTab === "dashboard" && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ["Fournisseurs", fournisseurs.length, "from-blue-500 to-cyan-500"],
              ["ICR", icrs.length, "from-green-500 to-emerald-500"],
              ["Dépôts", responsables.length, "from-orange-500 to-yellow-500"],
              ["Stations", stations.length, "from-purple-500 to-pink-500"],
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur">
              ...
              <form onSubmit={handleCreateFournisseur} className="space-y-3">
                ...
                <button type="submit" disabled={loading} className="w-full bg-orange-500 text-black font-semibold py-2 rounded-lg hover:bg-orange-400 transition">Créer</button>
              </form>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur">
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {fournisseurs.map((f) => (
                  <div key={f.id_fournisseur} className="border border-white/10 rounded-lg p-3 flex justify-between items-center">
                    <div>
        ...
        {activeTab === "responsables" && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur">
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {responsables.map((r) => (
                  <div key={r.id_responsable} className="border border-white/10 rounded-lg p-3 flex justify-between items-center">
                    <div>
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur">
              ...
              <form onSubmit={handleFixerPrix} className="space-y-4">
                ...
                <button type="submit" disabled={loading} className="w-full bg-orange-500 text-black font-semibold py-2 rounded-lg hover:bg-orange-400 transition">Fixer les prix</button>
              </form>
